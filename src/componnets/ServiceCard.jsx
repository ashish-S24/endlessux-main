...
function ServiceCard({icon , title , description}) {
  return (
    <div className='h-[398px] flex flex-col justify-around border border-card_border rounded-xl p-8 hover:border-primary transition-all ease-linear duration-150'>
